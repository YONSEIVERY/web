    ...
    <div className="max-w-2xl">
      ...
      <div className="mt-10 flex gap-3">
        ...
        <form action={async (formData) => {
          ...
          <button className="font-mono text-xs uppercase tracking-[0.28em] border border-red-600 text-red-400 px-6 py-3 hover:bg-red-600 hover:text-bg-base transition-colors">거절</button>
        </form>
      </div>
    </div>
  )
