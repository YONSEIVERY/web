 ...
 *
 * /curriculum이 산학협력·문의폼까지 담는 커리큘럼 전체 페이지라면,
 * /sessions는 세션 구조(정규 4단계 + 보조 3세션 + 닫는말)만 다루는
 * 짧은 페이지다. 홈·about의 SESSIONS 카드에서 여기로 연결.
 * 원본 카피는 lib/content/curriculum.ts에서 그대로 가져온다.
 */
